...
const pl = {
  ...
  contractTitle: (wage, years, remaining) =>
    `Kontrakt: ${wage}/tydz. · ${years} lat · pozostało: ${remaining}`,
  ...
  proposeLoanIn: 'Zaproponuj wypożyczenie',
...
const en = {
  ...
  contractTitle: (wage, years, remaining) =>
    `Contract: ${wage}/wk · ${years} yrs · ${remaining} left`,

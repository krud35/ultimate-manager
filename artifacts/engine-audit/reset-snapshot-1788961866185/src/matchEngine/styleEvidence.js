...
export const STYLE_OBSERVATIONS = {
 full: ['throws','cutStarts','underCuts','deepCuts','cutMeters','directionChanges','offenseSeconds','defenseSeconds','holdSeconds','fakeWindows','fakeActions','highDiscSeconds','jumpAttempts','sidelineSeconds','transitionSeconds','recoverySeconds'],
 fast: ['throws'],
}
...
export function recordStyleThrow(boxScore, thrower, mode, {type, success, curve = null, technique = null, tactics} = {}) {

...
export const STYLE_OBSERVATIONS = {
 full: ['throws','cutStarts','underCuts','deepCuts','cutMeters','directionChanges','offenseSeconds','defenseSeconds','holdSeconds','throwWindowSeconds','fakeWindows','fakeActions','highDiscSeconds','jumpAttempts','sidelineSeconds','transitionSeconds','recoverySeconds'],
 fast: ['throws'],
}

...
export const MISS_CALIBRATION = {
  ...
  // Full-match target 90–93%: preserve rare skill errors and reduce exaggerated
  // displacement from a marginal execution failure (see COMPLETION-90-93.md).
  cleanMargin: 0,
  missPerMarginPoint: 0.04,
  maxMissM: 15,
  missDistanceFractionCap: 0.4,
  /** Szansa realnej pomyłki rzucającego o umiejętności skillMissPivot; maleje liniowo
   *  do minMissChance. throwStat 60 -> 4%, 80 -> 2.22%, 95 -> 1.5%. */
  missChanceAtPivot: 0.04,
  minMissChance: 0.015,
  skillMissPivot: 60,
  skillMissSpan: 45,
  /** Gdy pomyłka nastąpi — punkt dostarczenia odchyla się o 0.7–1.7 m. */
  errorMissMinM: 0.7,
  errorMissSpanM: 1.0,
}

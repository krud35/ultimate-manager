...
export function defaultTacticsForPlayers(players) {
  ...
  return {
    ...
    forceSide: FORCE_SIDES.FORCE_FOREHAND,
    /**
     * Auto-zmiany: tryb i tagi rezerwowych. Wartości domyślne wstawia normalizeTactics
     * (lineups.js) przez normalizeAutoSubMode / normalizePlayerSubTagsMap — tu świadomie
     * BEZ importu z autoSub.js, żeby nie robić cyklu tacticsModifiers → autoSub →
     * offenseLineSlots → tacticsModifiers.
     */
    playerSubTags: {},
